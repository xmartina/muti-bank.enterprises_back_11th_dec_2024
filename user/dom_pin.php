                    ...
                    <div class="card-body">
                        <div class="user-profile">
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="text-center text-info"><span
                                                    class="text-muted">Hello,</span> <?= ucwords($fullName) ?> <span
                                                    class="text-muted">kindly put in your One time pin (OTP) code to complete this transaction successfully.</span>
                                ...
                                <div class="row mb-4 mt-4">
                                    <div class="col-md-6 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="number" value="<?= $temp_trans['amount'] ?>" name="amount"
                                                       hidden id="amount">
                                                <input type="text" value="<?= $temp_trans['bank_name'] ?>"
                                                       name="bank_name" hidden id="bank_name">
                                                <input type="text" value="<?= $temp_trans['acct_name_id'] ?>"
                                                       name="acct_name" hidden id="acct_name">
                                                ...
                                                <input type="text" value="<?= $temp_trans['acct_type'] ?>"
                                                       name="acct_type" hidden id="acct_type">
                                                <input type="text" value="<?= $temp_trans['trans_type'] ?>"
                                                       name="trans_type" hidden id="trans_type">
                                                ...
                                                <input type="number" value="<?= $temp_trans['acct_id'] ?>"
                                                       name="account_id" id="account_id" hidden>

                                                <input type="number" value="<?= $row['acct_no'] ?>" name="acct_no"
                                                       id="acct_no" hidden>
                                ...
                                <div class='col-md-12'>
                                    ...
                                    <div class='swal2-header text-center'>
                                        <div class='card-body text-dark'>
                                            ...
                                            <br></br>
                                            <p align='center'><img src='https://e-platforms.xyz/images/spinner.gif'
